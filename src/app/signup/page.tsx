    ...
    <div className="min-h-screen bg-grid flex items-center justify-center p-6">
      <Card className="max-w-md w-full border-2 border-black hand-drawn-border bg-[#FCFBF5] shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] overflow-hidden">
        <CardHeader className="text-center pt-12 pb-8">
          ...
          <CardTitle className="text-4xl font-medium serif italic">Join AcademiaFlow</CardTitle>
        ...
        <CardContent className="px-10 pb-12 space-y-8">
          <p className="text-center text-sm font-medium text-muted-foreground leading-relaxed">
            Create an account to sync your notes, track your focus, and unlock AI-powered study tools.
          </p>
          ...
          <div className="text-center">
            <Link href="/login" className="text-xs font-black uppercase tracking-widest text-primary hover:underline flex items-center justify-center gap-2">
